...
#salt = '12345678910'
#length_salt=11
#data='432f45b44c432414d2f97df0e5743818'
#md5(salt||data)='c36d738715819108921dfaae10bd1463'
#md5(salt||data||data)='ad1c57e6eac5d05987f2255b54172479'
#padding='0x80000000000000000000000000000000000000000000000000'
#append='0x2c00000000000000'
...
#md5(c||append)='a41a51b75511170e61715914c796ff58'
...
C=0xaefa1d92
D=0x6314bd10
printf('用得到的变量替换原算法中的链接变量，明文换为长度扩展后的'）
       import binascii
import sys
import os.path
...
if __name__ == "__main__":
    data = str('ad1c57e6eac5d05987f2255b54172479').encode("UTF-8")
